...
urlpatterns = [ 
    ...
    path('topicsearch/', views.topicsearch, name="topicsearch"),
    path('searchurls/', views.searchurls, name="searchurls"),
    path('extracturls/', views.extracturls, name="extracturls"),
